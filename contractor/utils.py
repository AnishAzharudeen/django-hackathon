CONTRACTOR_SKILLS_CHOICES = [
    ...
    ('roofing', 'Roofing'),
    ('shed', 'Sheds'),
    ('shower', 'Shower repairs'),
    ('tiling', 'Tiler'),
    ('tree', 'Tree Surgery'),
    ('upholstery', 'Upholstery cleaning'),
    ('wallpaper', 'Wallpaper hanging'),
